...
export const schema = z.object({
  ...
  type: z.string(),     // Slug
  layout: z.string(),   // Layout type
  status: z.string(),   // Done = Published, In Process = Draft, Deleted = Deleted
  target: z.string(),   // Views
  limit: z.string(),    // Author
  reviewer: z.string(), // Last Updated
})
      ...
      <form
        onSubmit={(e) => {
          ...
          toast.promise(new Promise((resolve) => setTimeout(resolve, 1000)), {
            loading: `Saving ${row.original.header} page details`,
            success: "Done",
            error: "Error",
          })
        }}
      ...
      onRestore: async (id: number) => {
        try {
          ...
          if (res.ok) {
            ...
            toast.success("Page restored as draft")
          } else {
    ...
    <Drawer open={open} onOpenChange={onOpenChange} direction={isMobile ? "bottom" : "right"}>
      <DrawerContent>
        <DrawerHeader className="gap-1">
          <DrawerTitle>{header || "Page Details"}</DrawerTitle>
          <DrawerDescription>
            {mode === "edit" ? "Edit Static Page Details & Layout" : "Static Page Details & Layout"}
          </DrawerDescription>
        </DrawerHeader>
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  Showing static page traffic statistics over the last 6 months.
                </div>
              </div>
              <Separator />
            </>
          ...
          <form id="drawer-post-form" onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Select value={layout} onValueChange={setLayout} disabled={mode === "view"}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                <Label htmlFor="limit">Author</Label>
                <Select value={limit} onValueChange={setLimit} disabled={mode === "view"}>
              ...
              <div className="flex flex-col gap-3">
                <Label htmlFor="reviewer">Last Updated</Label>
                <Input
                  id="reviewer"
                  value={reviewer}
